...
Name: Liane Yanglian
Login: xy48
Precept: not sure what this means, but I coded in Java 
OS: Mac
Text editor: I just used Eclipse 
Hours to complete assignment (optional): 8.5
...
I found the instructions to be a bit difficult to understand. It also took me quite a while to figure out why my planets disappeared from the screen after I wrote most of the code. 

/**********************************************************************
 *  If you created your own universe for extra credit, describe it
 *  here and why it is interesting.
 **********************************************************************/
I don't believe there's extra credit, according to Prof Azhar. 
 ...
 **********************************************************************/
 ...
 I copy pasted my answers to the analysis questions below because I'm not sure if we are supposed to include them here as well.
